...
class LogTestCase(BaseTestCase):
    ...
    def test_it_works(self) -> None:
        ...
        self.assertContains(r, "已发送邮件至 alice@example.org")
    ...
    def test_it_does_not_show_too_old_notifications(self) -> None:
        ...
        self.assertNotContains(r, "已发送邮件至 alice@example.org", status_code=200)
    ...
    def test_it_filters_success(self) -> None:
        ...
        self.assertNotContains(r, "hello world")
        self.assertContains(r, "已发送邮件至 alice@example.org", status_code=200)
    ...
    def test_it_shows_pushover_notification(self) -> None:
        ...
        self.client.login(username="alice@example.org", password="password")
        r = self.client.get(self.url())
        self.assertContains(r, "已发送 Pushover 通知", status_code=200)
    ...
    def test_it_shows_webhook_notification(self) -> None:
        ...
        self.client.login(username="alice@example.org", password="password")
        r = self.client.get(self.url())
        self.assertContains(r, "已调用 webhook foo/$NAME", status_code=200)
